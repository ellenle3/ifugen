...
void SetFDFromSlicerParamsAngular(IMAGE_SLICER_PARAMS *p, FIXED_DATA5 *FD);
void SetSlicerParamsFromFDAngular(IMAGE_SLICER_PARAMS *p, FIXED_DATA5 *FD);
...
int __declspec(dllexport) APIENTRY UserDefinedSurface5(USER_DATA *UD, FIXED_DATA5 *FD)
   ...
   IMAGE_SLICER_PARAMS_ANGULAR p; SetSlicerParamsFromFD(&p, FD);
