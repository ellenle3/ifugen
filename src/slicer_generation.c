...
// purpose.
void GetParaxialSliceIndex(int *col_num, int *slice_num, int active_x, int active_y, GRID_PARAMS_BASIC p) {
    *col_num = p.n_cols / 2;
...
int IsSectionValid(int col_num, int row_num, GRID_PARAMS_BASIC p) {
    if (row_num < 0 || row_num >= p.n_rows) {
        return 0;
    }
